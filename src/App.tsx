...
function App() {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'dark' : ''}`}>
      <div className="dark:bg-gray-900 bg-white min-h-screen text-gray-900 dark:text-white transition-colors duration-300">
        ...
        <main className="container mx-auto px-8 max-w-3xl min-h-screen py-32">
          <div className="space-y-32">
            <section className="space-y-8">
              <h1 className="text-3xl font-bold opacity-0 animate-fade-in">
                Hi, I'm Alejandro Obrador.
              </h1>
