    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'dark' : ''}`}>
      <div className="dark:bg-gray-900 bg-white min-h-screen text-gray-900 dark:text-white transition-colors duration-300 flex flex-col">
        <div className="absolute top-8 left-8 z-20">
          ...
          {menuOpen && (
            <div className="mt-3 w-40 rounded-xl border border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-lg p-2 animate-fade-in">
              <button
          ...
          {page === 'contact' && (
            <section className="space-y-10 opacity-0 animate-fade-in animation-delay-100">
              ...
              <div className="space-y-4">
                <a
                  href="mailto:alexobrador1619@gmail.com"
                ...
                >
                  ...
                  <p className="text-lg">alexobrador1619@gmail.com</p>
                </a>
